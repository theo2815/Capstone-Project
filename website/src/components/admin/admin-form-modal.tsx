...
const SUBMIT_BTN_CLS =
  "font-mono uppercase tracking-[0.25em] text-[13px] min-[400px]:text-[14px] md:text-[12px] text-ink border border-line hover:bg-ink hover:text-surface transition-colors rounded-full px-5 py-2 disabled:opacity-50 disabled:hover:bg-transparent disabled:hover:text-ink disabled:cursor-not-allowed";
